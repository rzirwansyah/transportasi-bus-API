...
const createBooking = async (req, res) => {
    ...
    `INSERT INTO
    booking(user_id, trip_id, trip_date, seat_number, first_name, last_name, user_id, email, created_on)
 ...
 * @param { object } req
 * @param { object } res
 * @returns { object } return response booking deleted successfully
 */
...
const updateBookingSeat = async (req, res) => {
    ...
    const updateBooking =
    `UPDATE booking SET seat_number = $1 WHERE user_id = $2 AND id = $3 returning *`;
...
export { createBooking, getAllBookings, deleteBooking, updateBookingSeat };