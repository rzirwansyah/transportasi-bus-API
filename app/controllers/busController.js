...
const addBusDetails = async (req, res) => {
    ...
    const createBusQuery =
    `INSERT INTO
    bus(number_plate, manufacturer, model, year, capacity, created_on)
    VALUES($1, $2, $3, $4, $5, $6)
    returning *`;
    const values = [number_plate, manufacturer, model, year, capacity, created_on];
...
const getAllBuses = async (req, res) => {
    ...
    const getAllBusQuery =
    `SELECT * FROM bus ORDER BY id DESC`;
...
export { addBusDetails, getAllBuses };